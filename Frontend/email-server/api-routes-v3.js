 ...
 */
router.post('/api/embeddings/generate', async (req, res) => {
 ...
 */
router.post('/api/embeddings/bulk-generate', async (req, res) => {
 ...
 */
router.get('/api/embeddings/status/:jobId', async (req, res) => {
 ...
 */
router.post('/api/search/similar', async (req, res) => {
 ...
 */
router.post('/api/search/duplicates', async (req, res) => {
 ...
 */
router.post('/api/analytics/quality-metrics', async (req, res) => {
